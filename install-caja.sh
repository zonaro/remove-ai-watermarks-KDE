#!/usr/bin/env bash
# =============================================================================
# Instala o menu de contexto "Remove AI Watermarks" no Caja (MATE).
#
# Abordagem: scripts em ~/.local/share/caja/scripts/ (zero dependência).
...
#        ~/.local/share/caja/scripts/Remove AI Watermarks/
#   3. Reinicia o Caja (caja -q) para o menu aparecer
# =============================================================================
set -euo pipefail
...
# ---------------------------------------------------------------------------
# Reinicia o Caja para recarregar os scripts
# ---------------------------------------------------------------------------
...
echo
echo "============================================================"
echo " Caja (MATE): instalação concluída!"
echo "============================================================"
