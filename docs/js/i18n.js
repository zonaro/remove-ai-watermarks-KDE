...
(function () {
    ...
    var TRANSLATIONS = {
        ...
        pt: {
            ...
            install: {
                title: 'Instalação',
                subtitle: 'O instalador instala o CLI <code>remove-ai-watermarks</code> (se necessário) e os menus de contexto — tudo com um comando.',
                step1: {
                    title: 'Instale tudo com um comando',
                    desc: 'O instalador detecta seu ambiente, instala o CLI <code>remove-ai-watermarks</code> se não estiver no PATH e adiciona os menus em todos os gerenciadores compatíveis.',
                ...
                step3: {
                    title: 'Instale o CLI manualmente (opcional)',
                    desc: 'O instalador já cuida disso. Para instalar manualmente (ou escolher outro conjunto de recursos):'
                }
            },
            usage: {
                title: 'Como usar',
        ...
        en: {
            ...
            install: {
                title: 'Installation',
                subtitle: 'The installer installs the <code>remove-ai-watermarks</code> CLI (when needed) and the context menus — all with one command.',
                step1: {
                    title: 'Install everything with one command',
                    desc: 'The installer detects your environment, installs the <code>remove-ai-watermarks</code> CLI if it is not on your PATH, and adds the menus to every compatible file manager.',
                ...
                step3: {
                    title: 'Install the CLI manually (optional)',
                    desc: 'The installer already handles this. To install manually (or choose a different feature set):'
                }
            },
            usage: {
                title: 'How to use',
        ...
        es: {
            ...
            install: {
                title: 'Instalación',
                subtitle: 'El instalador instala el CLI <code>remove-ai-watermarks</code> (si es necesario) y los menús de contexto — todo con un comando.',
                step1: {
                    title: 'Instala todo con un comando',
                    desc: 'El instalador detecta tu entorno, instala el CLI <code>remove-ai-watermarks</code> si no está en tu PATH y añade los menús a todos los gestores compatibles.',
                ...
                step3: {
                    title: 'Instala el CLI manualmente (opcional)',
                    desc: 'El instalador ya se encarga de esto. Para instalar manualmente (o elegir otro conjunto de funciones):'
                }
            },
            usage: {
                title: 'Cómo usar',
